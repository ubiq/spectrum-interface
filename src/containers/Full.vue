    ...
    fetch: function () {
      axios.get(this.$store.state.api + 'supply/ubq')
        .then(response => {
          ...
          return axios.get(this.$store.state.api + 'charts/txns/365')
        }).then(response => {
          this.$store.dispatch('setTxnsCount', response.data)

          return axios.get(this.$store.state.api + 'charts/avggasprice/365')
        }).then(response => {
          this.$store.dispatch('setAvgGasPrice', response.data)

          return axios.get(this.$store.state.api + 'charts/gaslimit/365')
        }).then(response => {
          this.$store.dispatch('setGasLimit', response.data)

          return axios.get(this.$store.state.api + 'charts/difficulty/365')
        }).then(response => {
          this.$store.dispatch('setDifficulty', response.data)

          return axios.get(this.$store.state.api + 'charts/hashrate/365')
        }).then(response => {
          this.$store.dispatch('setHashrate', response.data)

          return axios.get(this.$store.state.api + 'charts/blocktime/0')
        }).then(response => {
          ...
          let data = pooldata.map(r => r.data)
